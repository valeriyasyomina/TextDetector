...
{
    public class FirstTypeErrorProbabilityMetricFactory: AbstractMetricFactory
    {
        public override Metric GetMetric(double numerator, double denominator)
        {
            Metric metric = new FirstTypeErrorProbability();
        ...
        {
            return new FirstTypeErrorProbability(value);
        }
    }
}
